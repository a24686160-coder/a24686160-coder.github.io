...
document.querySelectorAll('.nav-btn').forEach(btn => {
    btn.addEventListener('click', function() {
        ...
        if (targetModal) {
            ...
            targetModal.querySelector('.modal-scroll').scrollTop = 0;
...
document.querySelectorAll('.modal-scroll').forEach(scroll => {
    scroll.addEventListener('scroll', function() {
        const blocks = this.querySelectorAll('.content-block');
...
// Запуск проверки видимости блоков после открытия модалки
document.querySelectorAll('.nav-btn').forEach(btn => {
    btn.addEventListener('click', function() {
        setTimeout(() => {
            const activeModal = document.querySelector('.page-modal.active');
            if (activeModal) {
                const scroll = activeModal.querySelector('.modal-scroll');
                if (scroll) {
